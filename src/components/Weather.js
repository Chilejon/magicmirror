...
class Weather extends Component {
    ...
    render() {
        ...
        for (var item in list) {
            console.log(list[item].weather[0])
            forecast40.push({
                "weather": "http://openweathermap.org/img/w/" + list[item].weather[0].icon + ".png",
                "dateTime": list[item].dt_txt
            }
            )
        }
        ...
        for (var item in forecast40) {
            icons.push(<section><img src={forecast40[item].weather} /><p>{forecast40[item].dateTime}</p></section>)
        }
        ...
        return (
            <fragment>
                ...
                {/* <h3>Wind: {this.state.weather.wind}</h3> */}
                {/* <br/>
